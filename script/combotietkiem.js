  ...
  productCards.forEach((card) => {
    ...
    card.addEventListener("click", (e) => {
      if (!e.target.closest(".add-to-cart")) {
        window.location.href = `chitietcombo.html?id=${encodeURIComponent(productId)}&name=${encodeURIComponent(productName)}&price=${productPrice}&image=${encodeURIComponent(productImage)}`;
      }
    });
